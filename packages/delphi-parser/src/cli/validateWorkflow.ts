...
if (existsSync(workflowPath)) {
  ...
  const requiredFragments = [
    ...
    'validate:fixture-frontend-form', 'validate:fixture-frontend-tabbed-form', 'validate:fixture-routes',
  ...
  const requiredCommands = [
    ...
    'validate:fixture-frontend-tabbed-form', 'validate:fixture-routes', 'validate:fixture-semantic', 'validate:fixture-coverage'
  ];
