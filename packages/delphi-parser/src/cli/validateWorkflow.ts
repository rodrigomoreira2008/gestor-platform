...
if (existsSync(workflowPath)) {
  ...
  const requiredFragments = [
    ...
    'validate:fixture-frontend-form', 'validate:fixture-frontend-tabbed-form', 'validate:fixture-frontend-lookup',
  ...
  const requiredCommands = [
    ...
    'validate:fixture-frontend-schema', 'validate:fixture-frontend-page', 'validate:fixture-frontend-form',
    'validate:fixture-frontend-tabbed-form', 'validate:fixture-frontend-lookup', 'validate:fixture-routes',
  ...
  const frontendFormStep = workflow.indexOf('Execute generated frontend form contract tests');
  const frontendTabbedFormStep = workflow.indexOf('Execute generated frontend tabbed form contract tests');
  const frontendLookupStep = workflow.indexOf('Execute generated frontend lookup contract tests');
