...
if (existsSync(workflowPath)) {
  ...
  const requiredFragments = [
    ...
    'validate:fixture-frontend-compile', 'validate:fixture-frontend-runtime', 'validate:fixture-routes', 'validate:fixture-semantic', 'validate:fixture-coverage'
  ];
